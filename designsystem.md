...
Our brand balances the elegant, editorial typography of **MADE Mirage** with the clean, geometric structure of **Questrial**, grounded in a natural, earthy neutral palette (**Stone**) and a distinct warm primary accent (**#A4674C**).
...
### 2.1 Font Families
* **Headings Font (Display, H1–H6):** `MADE Mirage`
...
| :--- | :--- | :--- | :--- | :--- | :--- |
| `font-size-130` | 130px | 6.190rem | `MADE Mirage` | 1.1 | **Display 1:** Used for oversized landing page heroes, large numerical metrics, or minimal splash headers. |
| `font-size-108` | 108px | 5.143rem | `MADE Mirage` | 1.1 | **Display 2:** Supporting oversized headers, large intro typographic treatments. |
| `font-size-90`  | 90px | 4.286rem | `MADE Mirage` | 1.15 | **Display 3:** Alternative hero headers or landing pages with dense copy layouts. |
| `font-size-75`  | 75px | 3.571rem | `MADE Mirage` | 1.2 | **Heading 1 (Max):** Main page titles on primary interior landing pages. |
| `font-size-63`  | 63px | 3.000rem | `MADE Mirage` | 1.2 | **Heading 1:** Standard top-level section title for standard pages. |
| `font-size-52`  | 52px | 2.476rem | `MADE Mirage` | 1.25 | **Heading 2:** Primary sub-section heading within a webpage. |
| `font-size-44`  | 44px | 2.095rem | `MADE Mirage` | 1.3 | **Heading 3:** Mid-level titles separating distinct text or card groups. |
| `font-size-36`  | 36px | 1.714rem | `MADE Mirage` | 1.35 | **Heading 4:** Card component titles, descriptive group titles. |
| `font-size-30`  | 30px | 1.429rem | `MADE Mirage` | 1.4 | **Heading 5:** Small sidebar headings, localized block descriptors. |
| `font-size-25`  | 25px | 1.190rem | `MADE Mirage` | 1.4 | **Heading 6 / Lead Paragraph:** Bold section labels or introduction text blocks. |
...
* **Page Title (H1):** `font-size-63` (`3.000rem`) | Font: `MADE Mirage` | Color: `stone-900` (`#1C1917`)
* **Section Title (H2):** `font-size-52` (`2.476rem`) | Font: `MADE Mirage` | Color: `stone-900` (`#1C1917`) or `color-primary` (`#A4674C`) for custom editorial emphasis.
